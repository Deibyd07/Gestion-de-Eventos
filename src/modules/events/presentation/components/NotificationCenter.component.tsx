...
import { Bell, Mail, MessageSquare, AlertCircle, CheckCircle, X, Filter, Search, Check } from 'lucide-react';
...
interface NotificationCenterProps {
  ...
  onCheck: (notificationId: string) => void;
...
export const NotificationCenter: React.FC<NotificationCenterProps> = ({
  ...
  const handleMarkSelectedAsRead = () => {
    selectedNotifications.forEach(id => onCheck(id));
    setSelectedNotifications([]);
  };
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="mt-3 flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      {!notification.isRead && (
                        <button
                          onClick={() => onCheck(notification.id)}
