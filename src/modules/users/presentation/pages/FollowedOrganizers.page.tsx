      ...
      <div className="w-full">
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-3 mb-2">
            ...
            <div>
              <h1 className="text-3xl sm:text-4xl font-bold text-gray-900">Organizadores Seguidos</h1>
          ...
          <div className="mb-6">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 shadow-sm"
              />
            </div>
          </div>
        )}
        ...
        {filteredOrganizers.length === 0 ? (
          ...
          <div className="grid grid-cols-[repeat(auto-fit,minmax(320px,1fr))] gap-6">
            {filteredOrganizers.map((organizer) => (
              <div
                key={organizer.id}
                className="bg-white rounded-xl border border-gray-200/70 hover:border-blue-300/60 shadow-sm hover:shadow-md transition-all duration-200 p-5 flex items-center gap-4 group"
              >
                <Link to={`/organizers/${organizer.id}`} className="block flex-shrink-0">
                  <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-purple-100 to-blue-100 ring-1 ring-gray-100 flex items-center justify-center overflow-hidden group-hover:scale-105 transition-transform duration-200">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-3 text-sm text-gray-600 mt-1">
                    ...
                    <span className="inline-flex items-center gap-1">
                      ...
                      Miembro desde {new Date(organizer.fecha_creacion).toLocaleDateString('es-ES', { month: 'short', year: 'numeric' })}
                    </span>
                  </div>
                  <div className="mt-2">
                    <Link
